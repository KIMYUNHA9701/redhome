...
<body>
    <div class="main">
        <h3 class="main-title">상품등록 페이지</h3>
        <form name="frm">
            <div class="form-group">
                <div class="group-label">제품번호</div>
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="제품번호" class="form-control" value="" name="product_num">
                </div>
            </div>
            <div class="form-group">
                ...
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="제품이름" class="form-control" value="" name="product_name">
                </div>
            </div>
            <div class="form-group">
                ...
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="제품사진" class="form-control" value="" name="product_img">
                </div>
            </div>
            <div class="form-group">
                ...
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="제품가격" class="form-control" value="" name="product_price">
                </div>
            </div>
            <div class="form-group">
                ...
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="재고량" class="form-control" value="" name="product_quantity">
                </div>
            </div>
            <div class="form-group">
                ...
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="판매량" class="form-control" value="" name="product_quantity_sold">
                </div>
            </div>
            <div class="form-group">
                ...
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="제품타입번호" class="form-control" value="" name="product_type_num">
                </div>
            </div>
            <div class="form-group">
                ...
                <%--<div class="group-description">다른 유저와 겹치지 않는 아이디 입력해주세요.</div>--%>
                <div class="group-input">
                    <input type="text" placeholder="카테고리번호" class="form-control" value="" name="product_category_num">
                </div>
            </div>
            <button class="submitBtn" type="button" onclick="registProduct()">상품등록</button>
        </form>
    </div>
</body>
</html>